...
public class GenerateSignedCertificate {
	static String Path = "/Users/gurongfang/Developers/workspace/Test/resources/"; 
	 ...
	 */
	public String signCSR(Reader pemcsr, int validity, KeyStore keystore, String alias, char[] password) throws Exception {
...
//	    out.close();
	...
	private static void main2() throws Exception
	{
		...
		System.out.println(gsc.signCSR(fileReader, valid_days, null, null, null));
